        ...
        <div className="flex items-center justify-between h-16 sm:h-17 gap-2 lg:gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            <button
              ...
              className="h-9 px-2.5 sm:px-3 rounded-xl text-xs font-bold text-slate-700 hover:text-emerald-800 hover:bg-emerald-50 border border-slate-200 hover:border-emerald-300 transition-all duration-150 flex items-center gap-1.5 shadow-2xs hover:shadow-sm shrink-0"
            ...
            <div className="relative" ref={notifRef}>
              <button
                ...
                className="h-9 w-9 rounded-xl text-slate-600 hover:text-slate-950 hover:bg-slate-100 hover:border-slate-300 transition-all duration-150 relative flex items-center justify-center border border-slate-200/70 shrink-0"
                title="Notifications"
              >
            ...
            <div className="relative" ref={roleRef}>
              <button
                ...
                className="h-9 px-2 sm:px-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 hover:border-slate-300 text-slate-800 text-xs font-bold flex items-center gap-1.5 transition-all duration-150 border border-slate-200 shrink-0"
              ...
              >
                ...
                />
                <span className="capitalize hidden md:inline text-xs font-bold">{currentRole}</span>
                <ChevronDown className="w-3 h-3 text-slate-400" />
              </button>
            ...
            {isSignedIn && user ? (
              <div className="relative" ref={profileRef}>
                <button
                  ...
                  className="h-9 flex items-center gap-1.5 p-1 pl-1.5 pr-2 rounded-xl border border-slate-200/90 hover:bg-slate-50 hover:border-slate-300 transition-all duration-150 shrink-0"
                >
                  {user.imageUrl ? (
                    <img
                      src={user.imageUrl}
              ...
              <button
                onClick={openSignIn}
                className="h-9 px-2.5 sm:px-3 rounded-xl border border-slate-200 hover:border-slate-300 hover:bg-slate-50 text-slate-700 text-xs font-bold flex items-center gap-1.5 transition-all duration-150 shadow-2xs hover:shadow-xs shrink-0"
              >
            ...
            <button
              ...
              className="h-9 px-3 sm:px-3.5 bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl text-xs font-bold transition-all duration-150 hover:-translate-y-0.5 active:translate-y-0 shadow-sm hover:shadow-md shadow-emerald-700/20 flex items-center gap-1.5 shrink-0"
            >
            ...
            <button
              ...
              className="lg:hidden h-9 w-9 rounded-xl text-slate-700 hover:bg-slate-100 hover:border-slate-300 flex items-center justify-center shrink-0 border border-slate-200/80 transition-colors"
